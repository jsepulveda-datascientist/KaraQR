            ...
            <div class="grid grid-cols-12 gap-4 mb-16">
                ...
                <div class="col-span-12 lg:col-span-4 py-4 lg:pl-12">
                    ...
                    <div class="flex flex-wrap gap-4 items-center mb-8">
                        <div
                            class="h-12 grow basis-0 border border-surface-300 dark:border-surface-500 text-surface-900 dark:text-surface-0 inline-flex justify-center items-center shrink-0 rounded mr-4 cursor-pointer hover:bg-surface-100 dark:hover:bg-surface-700 duration-150 transition-colors"
                            [ngClass]="{
                        ...
                        <div
                            class="h-12 grow basis-0 border border-surface-300 dark:border-surface-500 text-surface-900 dark:text-surface-0 inline-flex justify-center items-center shrink-0 rounded cursor-pointer hover:bg-surface-100 dark:hover:bg-surface-700 duration-150 transition-colors"
                            [ngClass]="{
