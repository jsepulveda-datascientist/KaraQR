...
@Component({
    ...
    template: `<div class="card h-full">
        ...
        <ul class="m-0 p-0 border-0 outline-0 list-none">
            <li class="py-4 px-0">
                <div *ngFor="let seller of sellers" class="h-16 border border-surface rounded-xl flex items-center p-4 mb-2 cursor-pointer hover:bg-emphasis transition-colors duration-150">
